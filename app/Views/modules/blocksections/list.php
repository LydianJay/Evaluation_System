                    ...
                    <div class="card-body pb-2">
                        <div class="table-responsive">
                            <table class="table table-sm align-items-center mb-0" id="dataTable">
                                <thead>
                                    <tr>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="text-align:center">SUBJECT CODE</th>
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="text-align:center">TITLE</th>
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="text-align:center">OPTION</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($records as $rec) { ?>
                                        <tr>
                                            <td style="text-align:center"><?php echo ucfirst($rec->subCode) ?></td>
                                            <td style="text-align:center"><?php echo ucfirst($rec->title) ?></td>
                                            <td style="text-align:center">
                                                <a href="<?php echo $current_page . '/view/' . $rec->subID ?>" class="btn btn-info btn-sm mb-0">VIEW</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
