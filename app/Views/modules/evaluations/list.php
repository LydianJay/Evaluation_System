                            ...
                            <table class="table table-sm align-items-center mb-0" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xl font-weight-bolder opacity-7" style="text-align:center">STATUS</th>
                                ...
                                <tbody>
                                    <?php foreach ($records as $rec) { ?>
                                        <tr>
                                            <td style="text-align:center"><?php echo $rec->name ?></td>
                                            <?php
                                            $status = '';
                                            $color  = '';
                                            if ($rec->status == 1) {
                                            ...
                                            <td style="text-align:center"><span class="text-<?php echo $color ?>"><?php echo $status ?></span> </td>
