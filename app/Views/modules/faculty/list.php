                            ...
                            <table class="table table-sm align-items-center mb-0" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xl font-weight-bolder opacity-7" style="text-align:center"></th>
                                ...
                                <tbody>
                                    <?php foreach ($records as $rec) { ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center"><?php echo ucfirst($rec->position) ?></td>
